...
-- Filteration on the basis of Group By and Where clause
--Where directly filter on Table and always used before Group by and Having always used after group by 
...
GROUP BY Country_of_Origin
having --Country_of_Origin = 'France'  or 
       Country_of_Origin = 'Germany'   or      
